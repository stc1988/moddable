...
#define FT_SIDE_TO_ROTATE( s )   ( FT_ANGLE_PI2 - (s) * FT_ANGLE_PI )
  ...
  /* MODDABLE: FT_Glyph_Stroke and FT_Glyph_StrokeBorder are the only functions   */
  /* here that need the FT_Glyph layer (ftglyph.c and ft_outline_glyph_class).    */
  /* Nothing in the SDK uses them, so they are omitted rather than dragging       */
  /* ftglyph.c into every build that strokes an outline.                          */
#ifdef MODDABLE_FT_GLYPH
